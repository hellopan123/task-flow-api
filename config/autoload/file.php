...
return [
    ...
    'storage' => [
        ...
        'hk' => [
            'driver' => \Hyperf\Filesystem\Adapter\AliyunOssAdapterFactory::class,
            'accessId' => env('HK_DOUBLE_RECORD_ACCESSID'),
            'accessSecret' => env('HK_DOUBLE_RECORD_ACCESS_SECRET'),
            'bucket' => env('HK_DOUBLE_RECORD_BUCKET'),
            'base_url' => env('HK_DOUBLE_RECORD_BASE_URL'),
            'endpoint' => env('HK_DOUBLE_RECORD_ENDPOINT'),
        ],
    ],
];

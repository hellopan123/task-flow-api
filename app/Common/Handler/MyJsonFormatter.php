...
class MyJsonFormatter extends NormalizerFormatter
{
    ...
    public function format(LogRecord $record): string
    {
        ...
        $new_data = [
            'time' => $normalized['datetime'],
            'request_id' => $normalized['extra']['request_id'] ?? '',
        ...
        return $this->toJson($new_data, true) . ($this->appendNewline ? "\n" : '');
    }
    ...
    /**
     * @return array<null|array<mixed>|bool|float|int|stdClass|string>
     */
     ...
     *
     * @return null|array<null|mixed[]|object|scalar>|object|scalar
     */
     ...
     *
     * @return array<array-key, array<array<string>|int|string>|int|string>
     */
